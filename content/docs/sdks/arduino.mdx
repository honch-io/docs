...
<Callout type="warn" title="Preview">Preview · `0.3.0`. ESP32-only. Use it for evaluation and controlled pilots until your product has passed hardware, TLS, offline-queue, flush, retry, and power-cycle validation.</Callout>
