...
- **Event buffer**: you control this directly via `event_buffer_size` in your config. The SDK README recommends >= 8192 bytes. This is where individual events and batches are staged as CBOR while encoding and flushing.
